import 'bloc/iphone_13_14_four_container_bloc.dart';
import 'models/iphone_13_14_four_container_model.dart';
...
class HomePage extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<Iphone1314FourContainerBloc>(
      create: (context) => Iphone1314FourContainerBloc(
        Iphone1314FourContainerState(
          iphone1314FourContainerModelObj: Iphone1314FourContainerModel(),
        ),
      )..add(Iphone1314FourContainerInitialEvent()),
      child: HomePage(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<Iphone1314FourContainerBloc,
        Iphone1314FourContainerState>(builder: (context, state) {
      return SafeArea(
        child: Scaffold(
          body: Navigator(
            key: navigatorKey,
            initialRoute: AppRoutes.mainpagePage,
